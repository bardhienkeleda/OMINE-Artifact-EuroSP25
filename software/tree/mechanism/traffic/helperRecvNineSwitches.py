...
class FeatureHeader(Packet):
    ...
    fields_desc=[IEEEFloatField("field0", 0),    # DNN Input Feature 0
                ...
                ByteField("count", 0),
                ByteField("weight9", 2),
                ByteField("weight9_2", 2),
                ByteField("output9", 2),
                ByteField("output10", 0),
                ByteField("ing_port", 0),
                ByteField("weight8", 6),
                ByteField("weight8_2", 6),
                ByteField("output8", 0),  
                
                ByteField("weight7", 2),
                ByteField("weight7_2", 2),
                ByteField("output7", 2),
                
                ByteField("weight6", 6),
                ByteField("weight6_2", 6),
                ByteField("output6", 0),        
                
                ByteField("weight5", 4),
                ByteField("weight5_2", 4),
                ByteField("output5", 4),
                
                ByteField("weight4", 5),
                ByteField("weight4_2", 5),
                ByteField("output4", 5),
                
                ByteField("weight3", 6),
                ByteField("weight3_2", 6),
                ByteField("output3", 0),

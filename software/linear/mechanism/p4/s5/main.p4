...
control IngressPipeImpl (inout parsed_headers_t hdr,
    ...
    apply {
        if(hdr.ipv4.protocol == 253 ){
            ...
            // weight.write((bit<32>)0, temp_val);
            // store_into_meta(); // Do i still need to store this?
            }
...
control EgressPipeImpl (inout parsed_headers_t hdr,
    ...
    action set_result_5(){
        ...
        // Testing code!!!
        // hdr.results_5.prediction4 = 0xFF;
        // hdr.results_5.prediction3 = 0xFF;
        // hdr.results_5.prediction2 = 0xFF;
        // hdr.results_5.prediction1 = 0xFF;

        // hdr.results_5.ts = standard_metadata.egress_global_timestamp;
        // hdr.outputs_5.setInvalid();
    }

    action set_result_4(){
        // hdr.ipv4.dst_addr = 0xDDDDDDDD;
    ...
    apply {
        ...
        if(standard_metadata.instance_type == 1){ // cloned packet
            ...
            // if(hdr.outputs.prediction4 == )
            // hdr.outputs.setInvalid();
            // Do we want to truncate for the reverse path?
            //truncate();
